...
dataset_name = '/zfs/hybrilit.jinr.ru/user/a/astrakh/nqs_frustrated_phase/data/square/32/0.0/AFM--states--1.0--0.6--8--4.mat'
...
phi = basis.get_vec(psi, sparse = False, pcon=True).astype(np.float32)
np.save(vector, phi)
