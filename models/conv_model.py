...
class Net(torch.jit.ScriptModule):
    def __init__(self, n: int):
        ...
        self._conv1 = torch.nn.Conv2d(1, 32, 5, stride=1, padding = 0, dilation=1, groups=1, bias=True)
        self._conv2 = torch.nn.Conv2d(32, 64, 5, stride=1, padding = 0, dilation=1, groups=1, bias=True)
        #self._conv3 = torch.nn.Conv2d(64, 128, 5, stride=1, padding = 0, dilation=1, groups=1, bias=True)
        self._dense6 = torch.nn.Linear(64, 2, bias=True)
